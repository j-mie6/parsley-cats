...
Global / onLoad ~= (_ andThen (s"project parsleyCats" :: _))

Compile / bloopGenerate := None
Test / bloopGenerate := None

lazy val parsleyCats = crossProject(JSPlatform, JVMPlatform, NativePlatform)
  ...
  .settings(
    ...
    libraryDependencies += "com.github.j-mie6" %%% "parsley" % "4.0.0" % Provided,
